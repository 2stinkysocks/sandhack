...
import me.travis.sandhack.hack.hacks.chat.ToggleMessages;
...
public class ClientMessage implements Globals {
    ...
    private static final String opener = ChatFormatting.GOLD + Sandhack.MODNAME + ChatFormatting.WHITE + " : " + ChatFormatting.RESET;

    public static void sendToggleMessage(Hack hack, boolean enabled) {
        if(mc.world != null && mc.player != null) {
            if(Sandhack.HACKS.ishackEnabled("togglemsgs")) {
    ...
    public static void sendIRCMessage(String message){
        sendMessage(ChatFormatting.WHITE + "["+ ChatFormatting.AQUA + "IRC - " + Sandhack.CHAT_HANDLING.mode + ChatFormatting.WHITE +"] " + ChatFormatting.RESET + message);
    }
