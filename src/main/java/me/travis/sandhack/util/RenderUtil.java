...
public class RenderUtil implements Globals {
    ...
    public static void drawText(BlockPos pos, String text, boolean custom) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double)  Sandhack.GUI_FONT_MANAGER.getTextWidth(text) / 2.0), 0.0, 0.0);
        if (custom) {
            Sandhack.GUI_FONT_MANAGER.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        } else {
