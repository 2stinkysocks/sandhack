...
public class ColorComponent extends Component {
    ...
    public void renderComponent(int mouseX, int mouseY) {
        RenderUtil2D.drawRectMC(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.MODULE_OFFSET, parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawRectMC(parent.parent.getX() + parent.parent.getWidth() - SandhackGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + SandhackGuiNew.MODULE_OFFSET, parent.parent.getX() + parent.parent.getWidth() - SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawRectMC(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + SandhackGuiNew.MODULE_OFFSET, parent.parent.getX() + parent.parent.getWidth() - SandhackGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + SandhackGuiNew.MODULE_OFFSET + 3, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawRectMC(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET, parent.parent.getX() + parent.parent.getWidth() - SandhackGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET - 3, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawBorderedRect(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + SandhackGuiNew.MODULE_OFFSET + 3, parent.parent.getX() + parent.parent.getWidth() - SandhackGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET - 3, 1, this.set.getValue().hashCode(), SandhackGuiNew.GUI_COLOR(), false);
        if (Gui.INSTANCE.customFont.getValue()) {
            Sandhack.GUI_FONT_MANAGER.drawStringWithShadow(set.getName(), parent.parent.getX() + SandhackGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 3 + SandhackGuiNew.MODULE_OFFSET, Gui.INSTANCE.fontColor.getValue().hashCode());
        } else {
            mc.fontRenderer.drawStringWithShadow(set.getName(), parent.parent.getX() + SandhackGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 3 + SandhackGuiNew.MODULE_OFFSET, Gui.INSTANCE.fontColor.getValue().hashCode());
        }
        if (this.isOpen) {
            SandhackGuiNew.drawRect(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.MODULE_OFFSET + SandhackGuiNew.HEIGHT, parent.parent.getX() + parent.parent.getWidth() - SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET + booleanButtonOffset, SandhackGuiNew.GUI_COLOR());
            ...
            RenderUtil2D.drawBorderedRect(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + 85, parent.parent.getY() + offset + 4 + SandhackGuiNew.MODULE_OFFSET + booleanButtonOffset, parent.parent.getX() + 115 - SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET - 2  + booleanButtonOffset, 1,this.set.getRainbow() ? new Color(set.getValue().getRed(), set.getValue().getGreen(), set.getValue().getBlue(), 255).hashCode() : SandhackGuiNew.GUI_COLOR(), new Color(0, 0, 0, 200).hashCode(), false);
            RenderUtil2D.drawRectMC(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + (this.set.getRainbow() ? 95 : 88), parent.parent.getY() + offset + 6 + SandhackGuiNew.MODULE_OFFSET + booleanButtonOffset, parent.parent.getX() + (this.set.getRainbow() ? 112 : 105) - SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET - 4 + booleanButtonOffset, new Color(50, 50, 50, 255).hashCode());
            if (Gui.INSTANCE.customFont.getValue()) {
                Sandhack.GUI_FONT_MANAGER.drawStringWithShadow("Rainbow", parent.parent.getX() + SandhackGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 5  + SandhackGuiNew.MODULE_OFFSET + booleanButtonOffset , Gui.INSTANCE.fontColor.getValue().hashCode());
            } else {
                mc.fontRenderer.drawStringWithShadow("Rainbow", parent.parent.getX() + SandhackGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 5  + SandhackGuiNew.MODULE_OFFSET + booleanButtonOffset , Gui.INSTANCE.fontColor.getValue().hashCode());
            }
        }
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (this.isOpen && firstTimeOpen) {
            ...
            for (Component component : this.parent.getChildren()) {
                ...
                if (flag) {
                    component.setOff(component.getOffset() + (SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET) * 5);
                }
            }
            this.firstTimeOpen = false;
        }
        if (this.isOpen && mouseOver(parent.parent.getX() + SandhackGuiNew.SETTING_OFFSET + 85, parent.parent.getY() + offset + 4 + SandhackGuiNew.MODULE_OFFSET + booleanButtonOffset, parent.parent.getX() + 115 - SandhackGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + SandhackGuiNew.HEIGHT + SandhackGuiNew.MODULE_OFFSET - 2  + booleanButtonOffset, mouseX, mouseY)) {
