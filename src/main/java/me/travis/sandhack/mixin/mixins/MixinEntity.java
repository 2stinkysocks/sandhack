...
import me.travis.sandhack.event.events.PushEvent;
...
public abstract class MixinEntity {
    ...
    public void move(MoverType type, double x, double y, double z) {
        ...
        if (this.noClip) {
            ...
            if (this.stepHeight > 0.0f && flag && (d2 != x || d4 != z)) {
                ...
                Sandhack.EVENT_PROCESSOR.postEvent(preEvent);
                double d14 = x;
                double d6 = y;
                double d7 = z;
                ...
                if (d14 * d14 + d7 * d7 >= x * x + z * z) {
                    ...
                    Sandhack.EVENT_PROCESSOR.postEvent(postEvent);
                }
            }
    ...
    public void addVelocityHook(Entity entity, double x, double y, double z) {
        ...
        Sandhack.EVENT_PROCESSOR.addEventListener(event);
