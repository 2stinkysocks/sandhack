...
import me.travis.sandhack.util.CrystalUtil;
...
public class Offhand extends Hack {
    ...
    public static class StopPlayerMovement {
        ...
        public static void toggle(boolean on) {
            if (on) {
                Sandhack.EVENT_PROCESSOR.addEventListener(stopPlayerMovement);
            } else {
                Sandhack.EVENT_PROCESSOR.removeEventListener(stopPlayerMovement);
            }
        }
