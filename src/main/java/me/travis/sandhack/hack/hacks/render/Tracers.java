...
public class Tracers extends Hack {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        mc.world.loadedEntityList.forEach(entity -> {
            ...
            if (!friends.getValue() && Sandhack.FRIEND_MANAGER.isFriend(player.getName())) return;
    ...
    public float[] getColorByDistance(Entity entity) {
        if (entity instanceof EntityPlayer && Sandhack.FRIEND_MANAGER.isFriend(entity.getName())) {
